    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="mm_stores"><a href="<?= site_url('customers/attendance'); ?>"><i class="fa fa-building-o"></i> <span>Attendance</span></span></a></li>
                <li class="treeview mm_auth mm_customers mm_suppliers">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="customers_add"><a href="<?= site_url('customers/add'); ?>"><i class="fa fa-circle-o"></i> Add Member</a></li>
