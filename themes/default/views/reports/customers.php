...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#fileData').DataTable({
            ...
            'ajax' : { url: '<?=site_url('reports/get_customers');?>', type: 'POST', "data": function ( d ) {
                ...
                <div class="box-body">
                        ...
                        <table id="fileData" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                            ...
                            <tr class="active">
                                ...
                                <th style="max-width:30px;">Membe Code</th>
                                <th style="max-width:30px;">Name</th>
                                <th style="max-width:30px;">Phone</th>
                                <th style="max-width:30px;">Email</th>
                                <th style="max-width:30px;">Start Date</th>
                                 <th style="max-width:30px;">End Date</th>
