...
function loadItems() {
  if ((1 == count && (spositems = {}), get("spositems"))) {
    ...
    if (1 != Settings.remote_printing) {
      var e =
        (r = "C: " + $("#select2-spos_customer-container").text() + "\n") +
        (i = "R: " + $("#hold_ref").val() + "\n") +
        (l = "U: " + username + "\n") +
        (c =
          "T: " +
          date(Settings.dateformat + " " + Settings.timeformat, t) +
          "\n") +
        "\n";
      ...
      var n =
        ...
        c =
          ...
          "</h5>";
      $("#order_span").prepend(
        n + s + "<h4>" + lang.order + "</h4></span>" + r + i + l + c
      ),
        $("#bill_span").prepend(
          n + s + "<h4>" + lang.bill + "</h4></span>" + r + i + l + c
        ),
        $("#order-table").empty(),
        $("#bill-table").empty();
    }
    (spositems = JSON.parse(get("spositems"))),
      $.each(spositems, function () {
        ...
        if (-1 !== f.indexOf("%")) {
          var h = f.split("%");
          isNaN(h[0]) ||
            (v = formatDecimal(parseFloat((m * parseFloat(h[0])) / 100), 4));
        }
        (product_discount += formatDecimal(v * l, 4)),
        ...
        null !== y &&
          ...
          (0 == r
            ? ((m -= b =
                formatDecimal((m * parseFloat(y)) / (100 + parseFloat(y)), 4)),
              (tax = lang.inclusive))
            : ((b = formatDecimal((m * parseFloat(y)) / 100, 4)),
              (tax = lang.exclusive))),
          (product_tax += formatDecimal(b * l, 4));
        ...
        (tr_html =
          ...
          (tr_html +=
            ...
            x +
            '">' +
            formatMoney(parseFloat(m) + parseFloat(b)) +
            "</span></td>"),
          (tr_html +=
          ...
          (tr_html +=
            ...
            x +
            '">' +
            formatMoney((parseFloat(m) + parseFloat(b)) * parseFloat(l)) +
            "</span></td>"),
          (tr_html +=
          ...
          (total += formatDecimal(
            (parseFloat(m) + parseFloat(b)) * parseFloat(l),
            4
          )),
          (count += parseFloat(l)),
          an++;
          ...
          "standard" == s && l > c
            ...
            : "combo" == s &&
              (!1 === i
                ? $("#" + x).addClass("danger")
                : $.each(i, function () {
                    parseFloat(this.quantity) < parseFloat(this.qty) * l &&
                      ($("#" + x).addClass("danger"),
                      $("#" + x)
                        .find(".edit")
                        .removeClass("bg-purple")
        ...
        if (1 != Settings.remote_printing) {
          ...
          (C += "</td><td>[ " + (0 != g ? "xxxx" : l) + " ]</td></tr>"),
            $("#order-table").append(C),
            $("#bill-table").append(D);
        }
      });
    var d = get("spos_discount")
      ? get("spos_discount")
      : $("#discount_val").val()
      ? $("#discount_val").val()
      : "0";
    ...
    if (
      ...
      var g = "";
      if (
        ((g += printLine(lang.total + ": " + formatMoney(total)) + "\n"),
        (order_discount > 0 || product_discount > 0) &&
          (g +=
            printLine(
              lang.discount +
                ": " +
      ...
      (f +=
        '<tr class="bb"><td colspan="2" style="text-align:center;">' +
        lang.merchant_copy +
        "</td></tr>"),
        $("#bill-total-table").empty(),
        $("#bill-total-table").append(f);
    }
...
$(document).ready(function () {
  $(document).on("click", ".no-results, #filter-suspended-sales", function (t) {
    ...
    $("#posTable").on("click", ".edit", function () {
      ...
      if (
        ((item_discount = formatDecimal(parseFloat(i))), -1 !== i.indexOf("%"))
      ) {
        var l = i.split("%");
        isNaN(l[0]) ||
          (item_discount = formatDecimal((r * parseFloat(l[0])) / 100));
      }
      r -= item_discount;
      ...
      null !== c &&
        0 != c &&
        (0 == parseFloat(n.row.tax_method)
          ? ((r -= d =
              formatDecimal((r * parseFloat(c)) / (100 + parseFloat(c)))),
            (p = lang.inclusive))
          : ((d = formatDecimal((r * parseFloat(c)) / 100)),
            (p = lang.exclusive))),
        console.log(o, a, e),
        $("#proModalLabel").html(
          '<a href="' +
    ...
    $(document).on("change", "#nPrice, #nDiscount", function () {
      ...
      if (
        ((item_discount = formatDecimal(parseFloat(n))), -1 !== n.indexOf("%"))
      ) {
        var s = n.split("%");
        isNaN(s[0]) ||
          (item_discount = formatDecimal((e * parseFloat(s[0])) / 100));
      }
      a -= item_discount;
      ...
      null !== r &&
        0 != r &&
        (0 == parseFloat(o.row.tax_method)
          ? ((a -= i =
              formatDecimal((a * parseFloat(r)) / (100 + parseFloat(r)))),
            (tax = lang.inclusive))
          : ((i = formatDecimal((a * parseFloat(r)) / 100)),
            (tax = lang.exclusive))),
    ...
    $(document).on("click", "#editItem", function () {
      ...
      (spositems[t].row.qty = parseFloat($("#nQuantity").val())),
        ...
        (spositems[t].row.discount = $("#nDiscount").val()
          ? $("#nDiscount").val()
          : "0"),
    ...
    $("#print_order").click(function (t) {
      if ((t.preventDefault(), count <= 1))
        ...
        if (($("#order-data").show(), 1 == Settings.print_img)) {
          ...
          html2canvas(e, { scrollY: 0, scale: 1.7 }).then(function (t) {
    ...
    $("#add_discount").click(function () {
      ...
      return (
        $("#get_ds").val(t), $("#dsModal").modal({ backdrop: "static" }), !1
      );
    }),
    ...
    $("#updateTax").click(function () {
      ...
      if (0 != t.length) {
        if (
          ($("#tax_val").val(t), store("spos_tax", t), -1 !== t.indexOf("%"))
        ) {
          var e = t.split("%");
          if (isNaN(e[0])) {
    ...
    $("#add_tax").click(function () {
      var t = $("#tax_val").val();
      return (
        $("#get_ts").val(t), $("#tsModal").modal({ backdrop: "static" }), !1
      );
    }),
    ...
    $("#add_item").autocomplete({
        ...
        $(this).val().length >= 16 && 0 == e.content[0].id
          ...
          ? ((e.item = e.content[0]),
            $(this)
              ...
              ._trigger("select", "autocompleteselect", e),
      ...
      select: function (t, e) {
        t.preventDefault(),
          0 !== e.item.id
            ? add_invoice_item(e.item) && $(this).val("")
            : bootbox.alert(lang.no_match_found);
      },
    }),
    ...
    $("#genNo").click(function () {
      ...
      return (
        $(this).parent().parent(".input-group").children("input").val(t), !1
      );
    }),
  ...
  $(document).on("click", ".posdel", function () {
    ...
    $("#amount").change(function (t) {
      ...
      $("#total_paying").text(formatMoney(e)),
        0 != Settings.rounding
          ? ($("#balance").text(formatMoney(e - round_total)),
    ...
    $(document).on("click", ".quick-cash", function () {
      ...
      var n = t.find("span");
      0 == n.length
        ? t.append('<span class="badge">1</span>')
    ...
    (spos_note = get("spos_note")) &&
      ($("#note").val(spos_note), $("#snote").val(spos_note)),
    $("#spos_customer").change(function (t) {
      store("spos_customer", $(this).val());
    }),
    (spos_customer = get("spos_customer")) &&
    ...
    $("body").click(function (t) {
      $(t.target).hasClass("sidebar-icon") ||
        $(t.target).hasClass("sb") ||
          ...
          success: function (t) {
            "success" == t.status
              ? ($("#spos_customer").append(
                  $("<option></option>").attr("value", t.id).text(t.val)
                ),
